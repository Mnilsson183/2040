...
class Sort {
public:
    static void Sort::bubble_sort(std::vector<int64_t>& A) {
    ...
    static void Sort::insertion_sort(std::vector<int64_t>& A) {
    ...
    static void Sort::selection_sort(std::vector<int64_t>& A) {
    ...
    static void Sort::merge_sort(std::vector<int64_t>& A) {
    ...
    static void Sort::quick_sort(std::vector<int64_t>& A) {
